    ...
    public abstract class DbContext
    {
        ...
        private Dictionary<Type, PropertyInfo> DiscoverDbSets()
        {
            var dbSets = this.GetType().GetProperties()
                .Where(pi => pi.PropertyType.GetGenericTypeDefinition() == typeof(DbSet<>)).ToDictionary(
        ...
        private string[] GetEntityColumnNames(Type table)
        {
            ...
            var columns = table.GetProperties()
                .Where(
                    pi => dbColumns.Contains(pi.Name) && !pi.HasAttribute<NotMappedAttribute>()
        ...
        private string GetTableName(Type tableType)
        {
            ...
            if (tableName == null) tableName = this.dbSetProperties[tableType].Name;
            ...
            where TEntity : class
        {
            ...
            var columns = this.GetEntityColumnNames(table);
            ...
            where TDbSet : class, new() where TCollection : class, new()
        {
            ...
            foreach (var entity in dbSet)
            {
                ...
                var navigationEntities = navigationDbSet.Where(
                    navigationEntity => primaryKey.GetValue(navigationEntity).Equals(primaryKeyValue)).ToArray();
            ...
            where TEntity : class, new()
        {
            ...
            var collections = entityType.GetProperties().Where(
            ...
            where TEntity : class, new()
        {
            ...
            if (modifiedEntities.Any()) this.connection.UpdateEntities(modifiedEntities, tableName, columns);
